...
We provide a pytest-based quality gate at `tests/models/quantization/test_quantization_quality.py`.
...
pytest tests/models/quantization/test_quantization_quality.py -v -m ""

# Run only your method
pytest tests/models/quantization/test_quantization_quality.py -v -m "" -k "int8"

# Run a specific model
pytest tests/models/quantization/test_quantization_quality.py -v -m "" -k "z_image"
```
...
1. Run the quality gate test with all layers quantized:
    ```bash
    pytest tests/models/quantization/test_quantization_quality.py -v -m "" -k "your_model"
    ```
