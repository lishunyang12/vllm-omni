...
Create a YAML configuration file in `vllm_omni/deploy/`. For a complete example, see the [Qwen3-Omni configuration file](gh-file:vllm_omni/deploy/qwen3_omni.yaml).
...
- **Stage config**: `vllm_omni/deploy/qwen3_omni.yaml`
