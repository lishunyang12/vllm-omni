...
Starting from the bundled `vllm_omni/deploy/qwen3_omni.yaml`:

```yaml
# vllm_omni/deploy/qwen3_omni.yaml (excerpt)
async_chunk: true
stages:
  - stage_id: 0
