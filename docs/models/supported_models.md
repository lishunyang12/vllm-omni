...
| `LTX2Pipeline`, `LTX2TwoStagePipeline` | LTX-2.5 joint video/audio — default distilled two-stage T2V/I2V, Full two-stage via `--task-type full`, and Full one-stage via `LTX2Pipeline` | `Lightricks/LTX-2.5` | ✅︎ | | | | [Repository](https://github.com/vllm-project/vllm-omni/blob/main/recipes/LTX/LTX-2.5.md) |
