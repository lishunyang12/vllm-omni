...
| `LTX2Pipeline`, `LTX2TwoStagePipeline` | LTX-2.5 joint video/audio — Full/SFT one-stage T2V/I2V and distilled two-stage T2V/I2V | `Lightricks/LTX-2.5-Diffusers` | ✅︎ | | | | [Repository](https://github.com/vllm-project/vllm-omni/blob/main/recipes/LTX/LTX-2.5.md) |
