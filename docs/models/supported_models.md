...
| `MiniMaxH3SuperDraftPipeline` + `LTX25H3RefinerPipeline` | MiniMax H3 Super Acceleration FL2VA | `MiniMaxAI/MiniMax-H3` + `lightx2v/Minimax-h3-Turbo` + `Lightricks/LTX-2.5-Diffusers` | ✅︎ | | | | — |
