...
class FLUXCrossAttention(nn.Module):
    ...
    def forward(
        ...
        attention_output = self.attn(
            query, key, value, attn_metadata=AttentionMetadata() if encoder_hidden_states_mask is None else None
        )
...
class FLUXTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        attn_output1 = self.attn1(modulated1, modulated1, encoder_hidden_states_mask)
        ...
        attn_output2 = self.attn2(modulated2, encoder_hidden_states, encoder_hidden_states_mask)
