...
| [`LTX/LTX-2.5.md`](./LTX/LTX-2.5.md) | Official raw LTX-2.5: default distilled two-stage, selectable Full two-stage, and Full one-stage T2V/I2V with synchronized audio | NVIDIA GPU; raw-path qualification pending |
