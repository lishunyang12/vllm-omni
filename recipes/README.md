...
| [`MiniMaxAI/MiniMax-H3.md`](./MiniMaxAI/MiniMax-H3.md) | T2VA, FL2VA, image+audio Ref2VA, and multi-video Ref2VA serving; [FastH3 VSA T2VA setup](./MiniMaxAI/MiniMax-H3.md#fasth3-vsa-serving) | 1x GPU with CPU offload / 4x B300; FastH3 requires resident weights |
