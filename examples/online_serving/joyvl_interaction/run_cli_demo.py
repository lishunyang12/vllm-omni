...
"""Headless demo: stream a video through the interaction server and print the
per-tick decision timeline.

    python run_cli_demo.py video.mp4 --query "Alert me if a fire breaks out"
"""
